...
--
-- Host: 127.0.0.1
-- Tempo de geração: 08/11/2025 às 11:46
...
ALTER TABLE `cidade`
  ...
  ADD UNIQUE KEY `nm_cidade` (`nm_cidade`),
...
ALTER TABLE `continente`
  ...
  ADD UNIQUE KEY `nm_continente` (`nm_continente`);
...
ALTER TABLE `pais`
  ...
  ADD UNIQUE KEY `nm_pais` (`nm_pais`),
  ADD UNIQUE KEY `cd_pais` (`cd_pais`),
