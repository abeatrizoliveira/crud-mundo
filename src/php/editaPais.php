...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $sql = "SELECT id_pais, nm_pais, qtd_populacao, nm_idioma, cd_continente FROM pais WHERE id_pais = '$id'";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE pais SET nm_pais='$nome', qtd_populacao='$populacao', nm_idioma='$idioma', cd_continente=$continente WHERE id_pais=$idPais";
